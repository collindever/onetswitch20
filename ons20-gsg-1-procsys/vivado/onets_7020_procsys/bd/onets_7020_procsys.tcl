...
################################################################
# This is a generated script based on design: onets_7020_procsys
#
...
# source onets_7020_procsys_script.tcl
...
set design_name onets_7020_procsys
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set FCLK_CLK0_125MHz [ create_bd_port -dir O -type clk FCLK_CLK0_125MHz ]
  set FCLK_CLK1_75MHz [ create_bd_port -dir O -type clk FCLK_CLK1_75MHz ]
  set FCLK_CLK2_200MHz [ create_bd_port -dir O -type clk FCLK_CLK2_200MHz ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {76.923080} \
   ...
   CONFIG.PCW_FPGA1_PERIPHERAL_FREQMHZ {75.000000} \
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports FCLK_CLK0_125MHz] [get_bd_pins processing_system7_0/FCLK_CLK0]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_ports FCLK_CLK1_75MHz] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_CLK2 [get_bd_ports FCLK_CLK2_200MHz] [get_bd_pins processing_system7_0/FCLK_CLK2]
